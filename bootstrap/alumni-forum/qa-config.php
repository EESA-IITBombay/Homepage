...
*/
	...
	define('QA_MYSQL_HOSTNAME',  $_SITE['dbHost']); // try '127.0.0.1' or 'localhost' if MySQL on same server
	define('QA_MYSQL_USERNAME',  $_SITE['dbUser']);
	define('QA_MYSQL_PASSWORD',  $_SITE['dbPass']);
	define('QA_MYSQL_DATABASE',  $_SITE['dbName']);
...
*/
	...
	define('QA_MYSQL_TABLE_PREFIX', 'af_');
...
*/
	define('QA_MYSQL_USERS_PREFIX', 'af_users_');
